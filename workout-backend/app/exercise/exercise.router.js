...
import { updateExerciseLogTime, updateCompleteExerciseLog } from './log/updateExerciseLog.controller.js';
...
router.route("/log/:id").get(protect, getExerciseLog).post(protect, createNewExerciseLog);
